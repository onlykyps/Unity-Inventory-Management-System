...
namespace Unity.AI.Navigation
{
    ...
    public partial class NavMeshLink : MonoBehaviour
    {
        ...
        {
            AddLink();
            if (m_AutoUpdatePosition && UnityEngine.AI.NavMesh.IsLinkValid(m_LinkInstance))
                AddTracking(this);
        }
        ...
        {
#if UNITY_EDITOR
            if (UnityEngine.AI.NavMesh.IsLinkValid(m_LinkInstance))
            {
            ...
            if (UnityEngine.AI.NavMesh.IsLinkValid(m_LinkInstance))
            {
                UnityEngine.AI.NavMesh.SetLinkOwner(m_LinkInstance, this);
